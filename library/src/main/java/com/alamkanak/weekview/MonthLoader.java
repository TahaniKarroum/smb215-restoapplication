...
public class MonthLoader implements WeekViewLoader {
    ...
    @Override
    public List<? extends WeekViewEvent> onLoad(int periodIndex) throws ParseException {
    ...
    public interface MonthChangeListener {
         ...
         */
        List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) throws ParseException;
    }
}
